...
$query = mysql_query("select distrito,count(distrito) as cantidad from datospescador group by distrito ASC",$conexion);
...
<table width="780" border=0 align="center" >
  <tr>
    <td colspan="3" >      
	  <h2 align="center" id="borderegistro">:: POBLACIÓN POR DISTRITO :: </h2>
	</td>
  </tr>
</table>
<br>
