...
$query = mysql_query("select municipio,count(municipio) as cantidad from datospescador group by municipio ASC;",$conexion);
...
<table width="780" border=0 align="center" >
  <tr>
    <td colspan="3" >      
	  <h2 align="center" id="borderegistro">:: POBLACIÓN POR MUNICIPIO :: </h2>
	</td>
  </tr>
</table>
<br>
