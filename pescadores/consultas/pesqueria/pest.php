...
$query = mysql_query("select dp.tespecie,dp.especie,sum(dp.volumen) as ton from datospescador p,cantidadembarcacion c, embarcacion e, datosproductivos dp WHERE idpescadores = id_datospescador and idcantidademb = id_cantidademb and idembarcacion=id_embarcacion and dp.mes='".$Mes."' and dp.anio='".$Anio."' GROUP BY tespecie ASC order by especie;",$conexion);
...
$table['cols'] = array(
    ...
    array('label' => 'OAXACA', 'type' => 'string'),
    array('label' => 'ESPECIE', 'type' => 'number'),
...
while($r = mysql_fetch_assoc($query)) {
    ...
    $temp[] = array('v' => (string) $r['tespecie']); 
	$cols[] = array('c' => $temp);
...
<table width="780" border=0 align="center" >
  <tr>
    <td colspan="3" >      
	  <h2 align="center" id="borderegistro">:: PESQUERIA ESTATAL :: </h2>
	</td>
  </tr>
</table>
