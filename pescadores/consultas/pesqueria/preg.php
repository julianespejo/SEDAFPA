...
$query = mysql_query("select p.region,dp.tespecie,dp.especie,sum(dp.volumen) as ton from datospescador p,cantidadembarcacion c, embarcacion e, datosproductivos dp WHERE idpescadores = id_datospescador and idcantidademb = id_cantidademb and idembarcacion=id_embarcacion and dp.mes='".$Mes."' and dp.anio='".$Anio."' GROUP BY tespecie ASC order by especie;",$conexion);
...
<link href="/sedafpa/styles/style.css" rel="stylesheet" type="text/css" media="screen">
    ...
    function drawChart() {
      ...
      var options = {
           title: "PRODUCCION POR REGIÓN (TON.)",
          is3D: true,
		  width: 900,
          height: 700
        };
...
<table width="780" border=0 align="center" >
  <tr>
    <td colspan="3" >      
	  <h2 align="center" id="borderegistro">:: PESQUERIA POR REGION :: </h2>
	</td>
  </tr>
</table>
