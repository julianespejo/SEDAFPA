...
$query = mysql_query("select p.region,sum(co.costototal) as total from datospescador p,cantidadembarcacion c, embarcacion e,costosdeoperacion co WHERE idpescadores = id_datospescador and idcantidademb = id_cantidademb and idembarcacion=id_embarcacion and co.mes='".$Mes."' and co.anio='".$Anio."' GROUP BY region",$conexion);
...
<table width="780" border=0 align="center" >
  <tr>
    <td colspan="3" >      
	  <h2 align="center" id="borderegistro">:: COSTOS DE PRODUCCIÓN POR REGIÓN :: </h2>
	</td>
  </tr>
</table>
...
<?php
	...
	<tr>
		...
		while($row = mysql_fetch_array($query))
		{
			...
			echo "<td  id='textoblue'><h5><center>$ " . $row['total'] . "</center></h5></td>";  
			echo "</tr>";
		}
		echo "</table>";
	}
...
<br>
<!--
<div align="center" id="reportepdf"><a href="../acuacultores/reportes/reporte_produccionzona.php">ver reporte pdf</a></div>
<div align="center" id="reportepdf"><a href="../acuacultores/reportes/reporte_produccionzonaexcel.php">ver reporte excel</a></div>
<br>
<br>-->
