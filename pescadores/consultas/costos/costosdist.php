...
$query = mysql_query("select p.distrito,sum(co.costototal) as total from datospescador p,cantidadembarcacion c, embarcacion e,costosdeoperacion co WHERE idpescadores = id_datospescador and idcantidademb = id_cantidademb and idembarcacion=id_embarcacion and co.mes='".$Mes."' and co.anio='".$Anio."' GROUP BY distrito;",$conexion);
...
<link href="/sedafpa/styles/style.css" rel="stylesheet" type="text/css" media="screen">
    ...
    function drawChart() {
      ...
      var options = {
           title: "PRODUCCION POR MUNICIPIO (TON.)",
          is3D: true,
		  width: 900,
          height: 700
        };
...
<table width="780" border=0 align="center" >
  <tr>
    <td colspan="3" >      
	  <h2 align="center" id="borderegistro">:: COSTOS DE PRODUCCIÓN POR DISTRITOS :: </h2>
	</td>
  </tr>
</table>
